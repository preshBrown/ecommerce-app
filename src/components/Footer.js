         ...
         <div className="row">
            <div className="col-4">
               ...
               <div className="footer-links d-flex flex-column">
                  <address className="text-white fs-6">
                     No: 277, Close-7<br /> Eligmbu<br />
                     Port Harcourt
                  </address>
                  <a href="tel:+2348032822977" 
                     className="mt-3 d-block mb-1 text-white">
                     +2348032822977
                  </a>
                  <a href="mailto: Brown222@gmail.com" 
            ...
            <div className="col-2">
               ...
               <div className="footer-links d-flex flex-column">
                  ...
                  <Link className=" text-white py-2 mn-1">watch</Link>
               </div>
            </div>
         </div>
      </div>
         ...
         <div className="row">
            <div className="col-12">
               <p className="text-center mb-0 text-white">
                  &copy; {new Date().getFullYear()}: Degitic Powered by shopify
               </p>
            </div>
         </div>
      </div>
